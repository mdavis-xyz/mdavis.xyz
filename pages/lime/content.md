...
I suspect the terms are so extreme that it is possibly illegal.
...
* The app has a map with icons of their available bikes. [Section 4.10](4.10) says they can put fictitious icons on the map which do not match a real bike, to mislead the users into thinking they have more bikes than they do. ([Section 6.2.6](6.2.6), [4.10](4.10)) For context, this is what [Uber already does](https://www.wired.co.uk/article/uber-cars-always-in-real-time).
* They can send you robocall spam, even if your number is on the Do Not Call list, and even after you close your account. ([Section 11.3](11.3)) They can send you email and phone calls from email addresses and phone numbers you did not give them, which they get through "other means". ([Section 11.4](11.4))
...
So if they over-charge you for a ride (such as charging you $600 for not locking the bike even though you really did), and do not notice for 2 months,
will not ever get that money back.
...
If you read this literally, it means Lime is not responsible for the security and confidentiality of your password and your account.
